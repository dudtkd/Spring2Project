...
public class FileUploadController02 {
	 ...
	 *  
	 *  	# 데이터베이스 만들기
	 *  	- FileUploadController01에서 데이터베이스를 생성하고 넘어옴
	 *  
	 *  	# 파일 업로드 구현 설명
	 *  
	 *  		- 파일 업로드 등록 화면 컨트롤러 만들기 (FileUploadController02)
	 *  		- 파일 업로드 등록 화면 컨트롤러 메소드 만들기 (item2ResgisterForm:get) 
	 *  		- 파일 업로드 등록 화면 만들기 (item2/register.jsp)
	 *  		- 여기까지 확인
	 *  
	 *  		- 파일 업로드 등록 기능 컨트롤러 메소드 만들기 (item2Resgister:post)

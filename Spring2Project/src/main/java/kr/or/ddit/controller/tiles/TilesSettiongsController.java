...
public class TilesSettiongsController {

	/*
	 * ================== 부트스트랩틀 이용한 CRUD 진행해봅니다 ============
	 * 
	 ...
	 *			- titlesViewResolver Bean 등록 진행
	 *
	 *			3) tiles 설정 위한 xml 생성
	 *			- /WEB-INF/spring/tiles-config.xml
	 *
	 *			3) tiles xml에 설정한 layout 설정대로 페이지 생성(jsp)			
	 * 
	 ...
	 * 			- 여기까지 확인
	 * 			
	 * 			- 게시판 상세 화면 컨트롤러 만들기(notice/NoticeRetieveController)
	 ...
	 * 			- 게시판 수정 화면  만들기(notice/detail.jsp)

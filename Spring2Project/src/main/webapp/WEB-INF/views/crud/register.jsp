...
<%-- 										<input class="form-control" type="text" name="title2" id="title2" value="${board.title }" placeholder="제목을 입력해주세요."/> --%>
								...
								<tr>
									<td>
										<input class="form-control" type="text" name="writer" id="writer" value="${board.writer }" placeholder="작성자 입력해주세요."/>
									</td>
								</tr>
								<tr>
									<td>
										<textarea class="form-control" name="content" id="content" cols="30" rows="5" >${board.content }</textarea>
									</td>
								</tr>
							</table>
						</form:form>

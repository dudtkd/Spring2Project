...
<section class="content">
	<div class="container-fluid">
		<div class="row">
				...
				<div class="card card-dark card-outline">
					...
					<div class="card-body">
						<div class="position-relative">
							<img src="${member.memProfileimg }" alt="Photo 1" id="profileImg" class="img-fluid">
						...
						<div class="row mt-2">
							...
							<div class="col-md-8">${member.memAddress1 } <br/> ${member.memAddress2 }</div>
						</div>
						<div class="row mt-2">
			...
			<div class="col-md-9">
				<div class="card card-dark card-outline">
					<form class="form-horizontal" method="post" action="/notice/profileUpdate.do" id="profileUpdateForm" enctype="multipart/form-data">
					<div class="card-header">
						<div class="row">
							<div class="col-md-10">
								<h4>내정보 수정</h4>
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="memId"
												name="memId" value="${member.memId }" placeholder="아이디를 입력해주세요." disabled="disabled">
										</div>
									</div>
									<div class="form-group row">

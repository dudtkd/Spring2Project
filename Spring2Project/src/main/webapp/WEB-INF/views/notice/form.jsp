									...
									<li>
										...
										<div class="mailbox-attachment-info">
											...
											<span class="mailbox-attachment-size clearfix mt-1"> 
												...
												<span class="btn btn-default btn-sm float-right attacmentFiledel" id="span_${noticeFile.fileNo }">
...
$(function(){
	CKEDITOR.replace("boContent",{
								// CK에디터에서 시큐리티 사용시 이미지를 보내주려면 ?${_csrf.parameterName}=${_csrf.token} 사용해야한다.
...
// 		var content = $("#boContent").val();
	...
	$(".attacmentFiledel").on("click",function(){
		var id = $(this).prop("id");

...
$(function(){
	...
	inputFile.on("change",function(event){
		...
		if(isImageFile(file)){
			...
			// processData : 데이터 파라미터를 data라는 속성에 넣는데, 제이쿼리 내부적으로 쿼리스트링을 구성합니다.
			...
			//				 WebkitFormBoundary[Hashkey~~~~~~~~~]' 와 같은 값으로 전송된 것을 확인할 수 잇습니다.
...
function isImageFile(file){
	...
	// 확장자중 이미지에 해당하는 확장자가 포함되어 있다면 0보다 큰 수 일테니 true가 리턴

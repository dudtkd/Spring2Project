...
<body>
	...
	<p>1) URL 경로 상의 쿼리 파리멑 정보로부터 요청 데이터를 취득할 수 있다. </p>
	...
	<form action="/registerMutipleSelect01" method="post">
		cars : <br/>
	...
	<form action="/registerMutipleSelect02" method="post">
		cars : <br/>
	...
	<p>7) 복수 선택이 가능한 폼 셀렉트 박스 요소값을 문자열 요소를 가진 리스트  </p>
	<form action="/registerMutipleSelect03" method="post">
		cars : <br/>
	...
	<p>8) 폼 체크 박스 요소값을 기본 데이터 타입인  문자열 타입 매개변수로 처리한다. </p>
	...
	<p>9) 폼 체크 박스 요소값을 문자열  배열 타입 매개변수로 처리한다. </p>
	...
	<p>10) 폼 체크 박스 요소값을 문자열 요소를 가진 리트스 컬렉션 타입 매개변수로 처리한다. </p>
	...
	<p>11) 폼 체크 박스 요소값을 기본 데이터 타입인 불리언 타입 매개변수로 처리한다. </p>
	...
	<p>7) 여러개의 파일업로드를 폼 파일 요소값과 텍스트 필드 요소값을 MultipartFileMember 타입의 자바빈즈 매개변수로 처리한다.</p>
	...
	<p>8) 파일업로드 폼 파일 요소값과 텍스트 필드 요소값을 MultipartFileMember 타입의 배열 매개변수로 처리한다.</p>
